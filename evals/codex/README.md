> **Migrated from `engineering-protocols/integrations/codex/`, 2026-08-22, under that
> repository's `epic:metaharness-migration`.** This is the Codex planning-plugin residue —
> instruction surface, skill copy and its instruction-surface check. The *driving* of Codex is
> `metaharness-codex`, this repository's adapter crate; this directory is the packaging and eval
> residue that predates it. Everything below is the original document.
