...
3. Spawns `b10x-harness run --execution-path metaharness --json …` with the flags below. The flag
   gives the inner agent attributable context about the outer observer and grants no authority.
   Stdout **is** the record.
