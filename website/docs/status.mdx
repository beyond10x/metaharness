...
The governed comparison subject, evaluation crate, and fixtures now use AEP's canonical naming;
the migration leaves the pinned frame and transcript wire formats unchanged.
